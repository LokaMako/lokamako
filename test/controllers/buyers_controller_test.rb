...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { address: @buyer.address, name: @buyer.name, phone: @buyer.phone, preferences: @buyer.preferences }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { address: @buyer.address, name: @buyer.name, phone: @buyer.phone, preferences: @buyer.preferences }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
